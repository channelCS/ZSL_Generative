...
parser.add_argument(
    "--syn_num", type=int, default=100, help="number features to generate per class"
)
parser.add_argument(
    "--gzsl",
    action="store_true",
...
parser.add_argument(
    "--ngh", type=int, default=4096, help="size of the hidden units in generator"
)
parser.add_argument(
    "--ndh", type=int, default=1024, help="size of the hidden units in discriminator"
)
parser.add_argument(
    "--nepoch", type=int, default=2000, help="number of epochs to train for"
)
parser.add_argument(
    "--critic_iter", type=int, default=5, help="critic iteration, following WGAN-GP"
)
parser.add_argument(
    "--lambda1",
    type=float,
    default=10,
    help="gradient penalty regularizer, following WGAN-GP",
)
parser.add_argument(
    "--lambda2",
    type=float,
...
parser.add_argument(
    "--lr", type=float, default=0.001, help="learning rate to train GANs "
)
parser.add_argument(
    "--feed_lr", type=float, default=0.0001, help="learning rate to train GANs "
)
parser.add_argument(
    "--dec_lr", type=float, default=0.0001, help="learning rate to train GANs "
)
parser.add_argument(
    "--classifier_lr",
    type=float,
...
parser.add_argument(
    "--validation", action="store_true", default=False, help="enables validation mode"
)
...
parser.add_argument(
    "--gammaD2", type=int, default=1000, help="weight on the W-GAN loss"
)
...
parser.add_argument(
    "--recons_weight", type=float, default=1.0, help="recons_weight for decoder"
)
...
parser.add_argument(
    ...
    action="store_true",
    default=False,
    help="Freeze Decoder for fake samples",
)
