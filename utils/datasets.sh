...
unzip CUB-20210425T113813Z-001.zip -d ../datasets
...
unzip AWA2-20210614T103407Z-001.zip -d ../datasets
...
unzip FLO-20210614T101759Z-001.zip -d ../datasets
...
unzip SUN-20210614T150751Z-001.zip -d ../datasets
